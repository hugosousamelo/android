...
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `Motif` (
  `mo_code` varchar(4) NOT NULL DEFAULT '',
  `mo_libelle` varchar(40) DEFAULT NULL,
  PRIMARY KEY (`mo_code`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `Motif` VALUES ('m895','Périodicité'),('m896','Nouveauté'),('m897','Actualité');
...
INSERT INTO `RapportVisite` VALUES ('a131',1,'2018-03-01','RAS','2018-03-01',1,false,22,'m896'),('a131',2,'2018-04-02','RAS','2018-04-02',2,false,22,'m897'),('a131',3,'2018-04-03','RAS','2018-04-03',3,false,18,'m896'),('a131',4,'2018-05-10','RAS','2018-05-10',4,false,22,'m897'),('a131',5,'2018-05-21','RAS','2018-05-21',5,false,18,'m895');
...
INSERT INTO `Visiteur` VALUES ('a131','Villechalane','Louis','azerty','8 cours Lafontaine','29000','BREST','2012-11-08',NULL,'SW'),('a17','Andre','David','azerty','1 rue Aimon de Chissee','38100','GRENOBLE','2008-06-19',NULL,'GY'),('a55','Bedos','Christian','azerty','1 rue Bénédictins','65000','TARBES','2007-09-07',NULL,'GY'),('a93','Tusseau','Louis','azerty','22 rue Renou','86000','POITIERS','2001-02-09',NULL,'SW'),('b13','Bentot','Pascal','azerty','11 avenue 6 Juin','67000','STRASBOURG','2003-11-06',NULL,'GY'),('b16','Bioret','Luc','azerty','1 rue Linne','35000','RENNES','2003-01-06',NULL,'SW'),('b19','Bunisset','Francis','azerty','10 rue Nicolas Chorier','85000','LA ROCHE SUR YON','2013-09-23',NULL,'GY'),('b25','Bunisset','Denise','azerty','1 rue Lionne','49100','ANGERS','2007-03-04',NULL,'SW'),('b28','Cacheux','Bernard','azerty','114 rue Authie','34000','MONTPELLIER','2008-02-10',NULL,'GY'),('b34','Cadic','Eric','azerty','123 rue Caponière','41000','BLOIS','2012-06-03','P','SW'),('b4','Charoze','Catherine','azerty','100 place Géants','33000','BORDEAUX','2009-05-07',NULL,'SW'),('b50','Clepkens','Christophe','azerty','12 rue Fédérico Garcia Lorca','13000','MARSEILLE','2011-08-18',NULL,'SW'),('b59','Cottin','Vincenne','azerty','36 square Capucins','5000','GAP','2010-12-19',NULL,'GY'),('c14','Daburon','François','azerty','13 rue Champs Elysées','6000','NICE','2012-01-20','S','SW'),('c3','De','Philippe','azerty','13 rue Charles Peguy','10000','TROYES','2005-05-29',NULL,'SW'),('c54','Debelle','Michel','azerty','181 rue Caponière','88000','EPINAL','2004-09-19',NULL,'SW'),('d13','Debelle','Jeanne','azerty','134 rue Stalingrad','44000','NANTES','2012-05-25',NULL,'SW'),('d51','Debroise','Michel','azerty','2 avenue 6 Juin','70000','VESOUL','2011-08-17','E','GY'),('e22','Desmarquest','Nathalie','azerty','14 rue Fédérico Garcia Lorca','54000','NANCY','2013-04-18',NULL,'GY'),('e24','Desnost','Pierre','azerty','16 rue Barral de Montferrat','55000','VERDUN','2013-04-18','E','SW'),('e39','Dudouit','Frédéric','azerty','18 quai Xavier Jouvin','75000','PARIS','2013-04-18',NULL,'GY'),('e49','Duncombe','Claude','azerty','19 avenue Alsace Lorraine','9000','FOIX','2012-09-16',NULL,'GY'),('e5','Enault-Pascreau','Céline','azerty','25B rue Stalingrad','40000','MONT DE MARSAN','2012-09-16','S','GY'),('e52','Eynde','Valérie','azerty','3 rue Henri Moissan','76000','ROUEN','2012-09-16',NULL,'GY'),('f21','Finck','Jacques','azerty','route Montreuil Bellay','74000','ANNECY','2012-09-16',NULL,'SW'),('f39','Frémont','Fernande','azerty','4 rue Jean Giono','69000','LYON','2005-05-29',NULL,'GY'),('f4','Gest','Alain','azerty','30 rue Authie','46000','FIGEAC','2005-05-29',NULL,'GY'),('g19','Gheysen','Galassus','azerty','32 boulevard Mar Foch','75000','PARIS','2005-05-29',NULL,'SW'),('g30','Girard','Yvon','azerty','31 avenue du 6 Juin','80000','AMIENS','2012-05-25','N','GY'),('g53','Gombert','Luc','azerty','32 rue Emile Gueymard','56000','VANNES','2012-05-25',NULL,'GY'),('g7','Guindon','Caroline','azerty','40 rue Mar Montgomery','87000','LIMOGES','2012-05-25',NULL,'GY'),('h13','Guindon','François','azerty','44 rue Picotière','19000','TULLE','2012-05-25',NULL,'SW'),('h30','Igigabel','Guy','azerty','33 rue Arlequin','94000','CRETEIL','2008-06-19',NULL,'SW'),('h35','Jourdren','Pierre','azerty','34 avenue Jean Perrot','15000','AURRILLAC','2008-06-19',NULL,'GY'),('h40','Juttard','Pierre-Raoul','azerty','34 cours Jean Jaurès','8000','SEDAN','2008-06-19',NULL,'GY'),('j45','Euré-Morel','Saout','azerty','38 cours Berriat','52000','CHAUMONT','2008-06-19','N','SW'),('j50','Landré','Philippe','azerty','4 avenue du Général Laperrine','59000','LILLE','2000-05-01',NULL,'GY'),('j8','Langeard','Hugues','azerty','39 avenue Jean Perrot','93000','BAGNOLET','2000-05-01','P','GY'),('k4','Lanne','Bernard','azerty','4 rue Bayeux','30000','NIMES','2000-05-01',NULL,'SW'),('k53','Le','Noël','azerty','4 avenue Beauvert','68000','MULHOUSE','2000-05-01',NULL,'SW'),('l14','Le','Jean','azerty','39 rue Raspail','53000','LAVAL','2000-05-01',NULL,'SW'),('l23','Leclercq','Servane','azerty','11 rue Quinconce','18000','BOURGES','1998-11-23',NULL,'SW'),('l46','Lecornu','Jean-Bernard','azerty','4 boulevard du Maréchal Foch','72000','LA FERTE BERNARD','1998-11-23',NULL,'GY'),('l56','Lecornu','Ludovic','azerty','4 rue Abel Servien','25000','BESANCON','1998-11-23',NULL,'SW'),('m35','Lejard','Agnès','azerty','4 rue Anthoard','82000','MONTAUBAN','1998-11-23',NULL,'SW'),('m45','Lesaulnier','Pascal','azerty','47 rue Thiers','57000','METZ','1998-11-23',NULL,'SW'),('n42','Letessier','Stéphane','azerty','5 chemin de Capuche','27000','EVREUX','1998-11-23',NULL,'GY'),('n58','Loirat','Didier','azerty','12 avenue Bourg la Croix','45000','ORLEANS','1998-11-23',NULL,'GY'),('n59','Maffezzoli','Thibaud','azerty','5 rue Chateaubriand','2000','LAON','2005-12-21',NULL,'SW'),('o26','Mancini','Anne','azerty','5 rue D\'\'Agier','48000','MENDE','2005-12-21',NULL,'GY'),('p32','Marcouiller','Gérard','azerty','7 place St Gilles','91000','ISSY LES MOULINEAUX','2005-12-21',NULL,'GY'),('p40','Michel','Jean-Claude','azerty','5 rue Gabriel Péri','61000','FLERS','2005-12-21','O','SW'),('p41','Montecot','Françoise','azerty','6 rue Paul Valéry','17000','SAINTES','2005-12-21',NULL,'GY'),('p42','Notini','Veronique','azerty','5 rue du Lieutenant Chabal','60000','BEAUVAIS','2005-12-21',NULL,'SW'),('p49','Onfroy','Den','azerty','5 rue Sidonie Jacolin','37000','TOURS','2005-12-21',NULL,'GY'),('p6','Pascreau','Charles','azerty','57 boulevard Mar Foch','64000','PAU','1997-03-30',NULL,'SW'),('p7','Pernot','Claude-Noël','azerty','6 rue Alexandre 1 de Yougoslavie','11000','NARBONNE','2003-01-02',NULL,'SW'),('p8','Perrier','Maître','azerty','6 rue Aubert Dubayet','71000','CHALON SUR SAONE','2006-06-23',NULL,'GY'),('q17','Petit','Jean-Louis','azerty','7 rue Ernest Renan','50000','SAINT LO','2009-06-07',NULL,'GY'),('r24','Piquery','Patrick','azerty','9 rue Vaucelles','14000','CAEN','2007-04-29','O','GY'),('r58','Quiquandon','Joëll','azerty','7 rue Ernest Renan','29000','QUIMPER','2006-09-30',NULL,'GY'),('s10','Retailleau','Josselin','azerty','88 bis rue Saumuroise','39000','DOLE','2011-12-05',NULL,'SW'),('s21','Retailleau','Pascal','azerty','32 boulevard Ayrault','23000','MONTLUCON','2009-05-09',NULL,'SW'),('t43','Souron','Maryse','azerty','7B rue Gay Lussac','21000','DIJON','2003-09-03',NULL,'SW'),('t47','Tiphagne','Patrick','azerty','7B rue Gay Lussac','62000','ARRAS','1997-08-29',NULL,'SW'),('t55','Tréhet','Alain','azerty','7D chemin Barral','12000','RODEZ','1994-11-29',NULL,'SW'),('t60','Tusseau','Josselin','azerty','63 rue Bon Repos','28000','CHARTRES','1991-03-29',NULL,'GY');
...
-- Dump completed on 2019-02-19 14:35:23
